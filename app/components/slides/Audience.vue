...
const profiles: AudienceProfile[] = [
  {
    ...
    description:
      'После работы он хочет быстро выбрать, куда пойти сегодня: от камерной выставки до большого концерта. Наш сервис собирает события в одном месте и экономит ему до 2 часов поиска в день.',
    tags: ['Техно', 'Искусство', 'Стритфуд', 'После работы'],
    pains: [
  ...
  },
  {
    ...
    description:
      'Он только переехал в город и пока не знает, куда ходить и с кем знакомиться. Наш сервис подсказывает события по интересам и помогает найти компанию уже в первый вечер.',
    tags: ['Кофейни', 'Нетворкинг', 'Бадди', 'Прогулки по городу'],
    pains: [
  ...
  },
  {
    ...
    description:
      'Он делает сильные события, но не может бесконечно тратить бюджет на рекламу. Наш сервис дает прямой канал связи с целевой аудиторией и прозрачную аналитику спроса.',
    tags: ['Комьюнити', 'Запуск', 'Аналитика', 'Удержание'],
    pains: [
      'Рекламные бюджеты съедают прибыль мероприятий.',
      'Трудно возвращать аудиторию на следующие события.',
      'Нужна прозрачная аналитика спроса и сегментов целевой аудитории.',
    ],
  },
]
  ...
  >
    ...
    <div class="relative z-10 mx-auto flex min-h-screen w-full max-w-[1700px] flex-col justify-center px-6 py-10 md:px-10 lg:px-14">
      <h2 class="audience-title max-w-[1220px] text-[clamp(1.95rem,4.7vw,5rem)] leading-[0.9] tracking-[-0.04em]">
        Наша целевая аудитория: люди, живущие в ритме города.
      </h2>
      ...
      <div class="cards-grid mt-8">
        ...
        >
          ...
          <div :ref="(el) => setPainRef(el, index)" class="pain-points">
            <p class="pain-title">С чем сталкивается:</p>
            <ul class="pain-list">
