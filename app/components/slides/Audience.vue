...
const profiles: AudienceProfile[] = [
  {
    ...
    description:
      'Хочет быстро решить, куда пойти сегодня вечером.',
    tags: ['Концерты', 'Выставки', 'Фестивали', 'После работы'],
    pains: [
      'События разбросаны по десяткам каналов',
      'Легко пропустить интересные мероприятия',
  ...
  },
  {
    ...
    description:
      'Ищет куда ходить и с кем знакомиться.',
    tags: ['Нетворкинг', 'Новые друзья', 'Прогулки', 'Знакомства'],
    pains: [
      'Нет рекомендаций и круга общения',
      'Неловко идти на события одному',
      'Сложно быстро встроиться в городскую среду',
    ],
  },
  {
    id: 3,
    ...
    description:
      'Хочет привлекать аудиторию без огромных рекламных бюджетов.',
    tags: ['Продвижение', 'Продажи билетов', 'Аналитика', 'Аудитория'],
    pains: [
      'Дорогая реклама съедает прибыль',
      'Сложно возвращать гостей на новые события',
      'Нет прозрачной аналитики аудитории',
    ],
  },
]
  ...
  >
    ...
    <div class="relative z-10 mx-auto flex min-h-screen w-full max-w-[1700px] flex-col justify-center px-6 py-10 md:px-10 lg:px-14">
      <h2 class="audience-title max-w-[1220px] text-[clamp(1.95rem,4.7vw,5rem)] leading-[0.9] tracking-[-0.04em]">
        Наша аудитория — люди, живущие в ритме города
      </h2>
      <p class="audience-subtitle mt-3 max-w-[980px] text-[clamp(0.92rem,1.25vw,1.2rem)]">
        Мы решаем проблемы трех ключевых пользователей.
      </p>
