...
<template>
  ...
  >
    ...
    <div class="relative z-20 flex min-h-screen items-center justify-center px-6 py-10 md:px-10">
      ...
      >
        <h2 class="problem-title text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)]">Найти интересное событие в городе до сих пор сложно</h2>
        <div class="problem-copy">
          <p>
            Спрос растет: продажи билетов выросли на 41%.
          </p>
          <p>
            Но события разбросаны по соцсетям, чатам и локальным пабликам
          </p>
          <p>
            В регионах нет удобных агрегаторов
          </p>
          <p>И даже если событие найдено — часто не с кем пойти.</p>
        </div>
      </div>
    </div>
  </section>
