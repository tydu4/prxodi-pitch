    ...
    <div class="relative z-20 flex min-h-screen items-center justify-center px-6 py-10 md:px-10">
      ...
      >
        ...
        <div class="problem-copy">
          <p>
            Информационный хаос и социальный барьер убивают досуг.
          </p>
          <p>
            Афиши показывают только коммерческий мейнстрим. Весь уникальный локальный досуг (квартирники, лекции, локальные тусовки) размазан по тысячам закрытых чатов и пабликов.
          </p>
          <p>
            «Не с кем пойти» — главная причина отказа от покупки билета. Даже найдя крутое событие, человек остается дома, если его друзья заняты, потому что идти одному — некомфортно. Город теряет деньги, а люди — эмоции.
          </p>
        </div>
      </div>
    </div>
