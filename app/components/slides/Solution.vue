...
const solutionBlocks: SolutionBlock[] = [
  {
    title: 'AI-агрегатор событий',
    description:
      'Мы автоматически собираем события из сотен источников: соцсетей, пабликов и локальных афиш.',
    mode: 'feed',
  },
  {
    title: 'Умные рекомендации',
    description:
      'Алгоритмы подбирают события по интересам и вайбу. А встроенный поиск единомышленников помогает найти компанию.',
    mode: 'map',
  },
  {
    title: 'Социальная механика мероприятия',
    description:
      'До события — матч по интересам, На входе — быстрый чек-ин, Во время — live-стена и общение, После — аналитика для организаторов',
    mode: 'friend',
  },
]
