...
<template>
  <section ref="root" class="psb-slide relative isolate min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-white to-blue-50 flex flex-col items-center justify-center p-4 md:p-6">
    
    <div class="absolute inset-0 z-0 pointer-events-none overflow-hidden">
      <div v-for="(offset, index) in bubbleOffsets" :key="`bubble-${index}`" 
           class="psb-bubble absolute left-[calc(var(--rnd)*100%)] w-12 h-12 md:w-20 md:h-20 flex items-center justify-center"
           :style="{ '--rnd': offset }"
      >
    ...
    <div class="relative z-10 mb-6 md:mb-8 text-center w-full max-w-5xl">
      <div class="hook-container inline-flex flex-col md:flex-row items-center justify-center gap-3 md:gap-5 bg-white/60 backdrop-blur-md border border-[var(--psb-blue)]/20 p-4 md:p-6 rounded-[32px] shadow-2xl">
        
        <div class="hook-prihodi flex items-center gap-2 md:gap-3">
          <div class="w-10 h-10 md:w-14 md:h-14 rounded-full bg-[var(--psb-orange)] flex items-center justify-center text-white shadow-lg">
          ...
          <span class="text-4xl md:text-5xl font-black text-[var(--psb-ink)] uppercase tracking-tighter">ПРИХОДИ</span>
        </div>
        ...
        <div class="hook-in flex flex-col items-center">
          ...
          <div class="w-1 h-6 bg-[var(--psb-orange)] rounded-full mt-1 animate-pulse"></div>
        </div>

        <div class="hook-psb flex items-center gap-2 md:gap-3">
           <span class="text-4xl md:text-5xl font-black text-[var(--psb-blue)] uppercase tracking-tighter">ПСБ</span>
           <div class="w-10 h-10 md:w-14 md:h-14 rounded-2xl bg-[var(--psb-blue)] flex items-center justify-center text-white shadow-lg overflow-hidden">
    ...
    <div class="bento-grid relative z-10 w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-3 md:gap-4">
      ...
      <article class="bento-card lg:col-span-5 group relative overflow-hidden rounded-[24px] bg-white border-2 border-[var(--psb-orange)] p-5 md:p-6 shadow-[8px_8px_0px_rgba(255,102,0,0.2)] hover:shadow-[12px_12px_0px_rgba(255,102,0,0.3)] transition-all">
        <h3 class="text-xl md:text-2xl font-bold text-[var(--psb-ink)] mb-3 uppercase">Акселератор (Факт)</h3>
        <div class="flex items-center justify-between gap-2 md:gap-4">
           <div class="text-center">
             <span class="block text-xs md:text-sm font-bold text-gray-400 uppercase tracking-widest">Было</span>
             <span class="text-4xl md:text-5xl font-black text-gray-300 line-through decoration-red-500 decoration-4">20</span>
             <span class="block text-xs md:text-sm text-gray-400 mt-1">команд</span>
           </div>
           <div class="text-2xl font-black text-[var(--psb-blue)]">➜</div>
           <div class="text-center">
             <span class="block text-xs md:text-sm font-bold text-[var(--psb-blue)] uppercase tracking-widest">Будет</span>
             <span class="counter-val text-5xl md:text-5xl font-black text-[var(--psb-orange)]">200</span>
             <span class="block text-xs md:text-sm text-[var(--psb-orange)] font-bold mt-1">целевых заявок</span>
           </div>
        </div>
...
платформа может стать
         ...
         <div class="mt-3 flex items-center gap-2">
            <span class="w-2 h-2 md:w-3 md:h-3 bg-green-500 rounded-full animate-pulse"></span>
            <span class="text-xs md:text-sm font-bold uppercase tracking-widest text-green-400">Region Locked</span>
         </div>
      </article>

      <article class="bento-card lg:col-span-8 group relative overflow-hidden rounded-[24px] bg-gradient-to-r from-gray-100 to-white border-2 border-gray-200 p-5 flex items-center justify-between shadow-lg">
        ...
        <div class="hidden sm:flex w-20 h-20 bg-[var(--psb-blue)] rounded-2xl items-center justify-center rotate-6 group-hover:rotate-12 transition-transform shadow-2xl overflow-hidden">
            <img :src="psbLogos[5]" class="w-10 h-10 object-contain" alt="logo">
        </div>
      </article>
